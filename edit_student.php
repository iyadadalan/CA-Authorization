...
// Redirect if not logged in or role is not appropriate
...
if (isset($_POST['id'])) {
    ...
    // Access control: Only allow edits if admin or the owner of the record
...
<body>
    <div class="container mt-5">
        ...
        <input type="hidden" name="id" value="<?php echo $id; ?>">
            ...
            <div class="mb-3">
                <label the form-label">Mobile Phone No:</label>
